...
do
	...
	rm -rf node_modules
	pnpm cache clear --force
	(echo '' && echo 'construction pnpm angular cache clear rm occurs '$index && time pnpm install) &>> ../results/benchmarkPnpmEmber.txt
...
do
	echo "Je fais pnpm install pour angular avec rm: index "$index
	rm -rf node_modules
	(echo '' && echo 'construction pnpm angular rm occurs '$index && time pnpm install) &>> ../results/benchmarkPnpmEmber.txt
...
do
	echo "Je fais pnpm install pour angular : index "$index
	(echo '' && echo 'construction pnpm angular occurs '$index && time pnpm install) &>> ../results/benchmarkPnpmEmber.txt
...
do
	...
	rm -rf node_modules
	pnpm cache clear --force
	(echo '' && echo 'construction pnpm alot cache clear rm occurs '$index && time pnpm install) &>> ../results/benchmarkPnpmAlot.txt
...
do
	...
	rm -rf node_modules
	(echo '' && echo 'construction pnpm alot rm occurs '$index && time pnpm install) &>> ../results/benchmarkPnpmAlot.txt
...
do
	...
	(echo '' && echo 'construction pnpm alot occurs '$index && time pnpm install) &>> ../results/benchmarkPnpmAlot.txt
...
do
	...
	rm -rf node_modules
	pnpm cache clear --force
	(echo '' && echo 'construction pnpm medium cache clear rm occurs '$index && time pnpm install) &>> ../results/benchmarkPnpmMedium.txt
...
do
	...
	rm -rf node_modules
	(echo '' && echo 'construction pnpm medium rm occurs '$index && time pnpm install) &>> ../results/benchmarkPnpmMedium.txt
...
do
	...
	(echo '' && echo 'construction pnpm medium occurs '$index && time pnpm install) &>> ../results/benchmarkPnpmMedium.txt
...
do
	...
	rm -rf node_modules
	yarn cache clean
	(echo '' && echo 'construction pnpm ember cache clear rm occurs '$index && time yarn install) &>> ../results/benchmarkYarnEmber.txt
...
do
	...
	rm -rf node_modules
	(echo '' && echo 'construction yarn ember rm occurs '$index && time yarn install) &>> ../results/benchmarkYarnEmber.txt
...
do
	...
	(echo '' && echo 'construction yarn ember occurs '$index && time yarn install) &>> ../results/benchmarkYarnEmber.txt
...
do
	...
	rm -rf node_modules
	yarn cache clean
	(echo '' && echo 'construction yarn alot cache clear rm occurs '$index && time yarn install) &>> ../results/benchmarkYarnAlot.txt
...
do
	...
	rm -rf node_modules
	(echo '' && echo 'construction yarn alot rm occurs '$index && time yarn install) &>> ../results/benchmarkYarnAlot.txt
...
do
	...
	(echo '' && echo 'construction yarn alot occurs '$index && time yarn install) &>> ../results/benchmarkYarnAlot.txt
...
do
	...
	rm -rf node_modules
	yarn cache clean
	(echo '' && echo 'construction yarn medium cache clear rm occurs '$index && time yarn install) &>> ../results/benchmarkYarnMedium.txt
...
do
	...
	rm -rf node_modules
	(echo '' && echo 'construction yarn medium rm occurs '$index && time yarn install) &>> ../results/benchmarkYarnMedium.txt
...
do
	...
	(echo '' && echo 'construction yarn medium occurs '$index && time yarn install) &>> ../results/benchmarkYarnMedium.txt
